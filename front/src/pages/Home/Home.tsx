  ...
  return (
    <div className={styles.homeCont}>
      ...
      <section className={styles.whySection}>
        ...
        <div className={styles.featuresCont}>
          ...
          <Feature icon="sync" title="Always up to date" color="green">
            Update your shifts anytime. Shared schedules always reflect the
            latest changes.
          </Feature>
          <Feature
            icon="visibility"
            ...
            color="yellow"
          >
            No ads, no clutter. Just your schedule, clearly presented.
          </Feature>
        </div>
      </section>
      ...
      <section className={styles.howSection}>
        <h2>How it works</h2>
        <div className={styles.howPointsCont}>
          <div className={styles.howPoint}>
            ...
            <div>
              ...
              <p>
                Select a week and add your daily shifts with start and end
                times.
              </p>
            </div>
          </div>
      ...
      <section className={styles.whoSection}>
        ...
        <div className={styles.whoPoints}>
